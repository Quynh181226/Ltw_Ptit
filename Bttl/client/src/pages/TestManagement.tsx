            ...
            >
                ...
                <div className="menu top">
                    ...
                    <div className="menu-item active">
                        ...
                        >
                            <svg className="min-w-[40px] flex justify-center"  xmlns="http://www.w3.org/2000/svg"    width="20" height="20" fill="#6B7597" viewBox="0 0 24 24" ><path d="M4 2H2v19c0 .55.45 1 1 1h19v-2H4z"></path><path d="M7 10h11c.55 0 1-.45 1-1V5c0-.55-.45-1-1-1H7c-.55 0-1 .45-1 1v4c0 .55.45 1 1 1m10-2h-5V6h5zM8 6h2v2H8zM21 12H7c-.55 0-1 .45-1 1v4c0 .55.45 1 1 1h14c.55 0 1-.45 1-1v-4c0-.55-.45-1-1-1M8 14h6v2H8zm12 2h-4v-2h4z"></path></svg>
