...
import {getByEmail, add, login, updateUser, getAllUsers, deleteUser, updateUserStatus, logout,} from "../apis/UserApi";
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(logout.fulfilled, (state, action) => {
                const updated = action.payload as { id: number; active: boolean; waiting: boolean };
