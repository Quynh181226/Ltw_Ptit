...
const Header1 = ({ onLogout }: HeaderProps) => {
    ...
    const userMenu = (
        <Menu className="w-72 p-4 rounded-lg shadow-lg border border-gray-200">
            ...
            <Menu.Item key="signout">
                <span onClick={onLogout} className="text-red-800 font-semibold hover:bg-gray-100 block px-2 py-1 rounded">
                    Đăng xuất
                </span>
            </Menu.Item>
        </Menu>
    ...
    return (
        <div className="flex items-center justify-between px-3 py-3.5  bg-gray-200 font-sans">
            {/*<div id="logoHome">*/}
            {/*    <img src="/assets/Group 1.svg" alt="Logo" className="h-10" />*/}
            {/*</div>*/}
            <Link to="/categoryManagement" className="text-xl md:text-2xl font-bold text-gray-700">UniLife Hub</Link>
            ...
            <nav className="hidden md:flex">
                ...
                <div className="flex items-center gap-12">
                    <div className="flex items-center gap-4 text-gray-800 font-semibold">
                        <Link to="/categoryManagement"  className="cursor-pointer hover:text-gray-600" id="testPage">
                            danh mục
                        </Link>
                        <Link to="/testManagement"  className="cursor-pointer hover:!text-gray-600" id="topicPage">
                            test
                        </Link>
                        <Link to="/studentManagement"  className="cursor-pointer hover:!text-gray-600" id="topicPage">
                            Student
                        </Link>
                        <Link to="/examManagement"  className="cursor-pointer hover:!text-gray-600" id="topicPage">
                            ktra
                        </Link>
                        <Link to="/homePage">hp</Link>
            ...
            {open && (
                <div className="flex flex-col gap-2         absolute z-50 top-14 right-4 bg-white rounded-lg shadow-lg border border-gray-200 p-4 md:hidden">
                    ...
                    {/*</li>*/}
                    {/*<li>*/}
                    <Link to="/categoryManagement" className="text-gray-700 font-semibold hover:bg-gray-100 block px-2 py-1 rounded" onClick={() => setOpen(false)}>Category</Link>
                    <Link to="/testManagement" className="text-gray-700 font-semibold hover:bg-gray-100 block px-2 py-1 rounded" onClick={() => setOpen(false)}>Test</Link>
                    <Link to="/course" className="text-gray-700 font-semibold hover:bg-gray-100 block px-2 py-1 rounded" onClick={() => setOpen(false)}>Test</Link>
                    <Link
                        to="/login"
                        onClick={() => {
                            onLogout();
