...
const Header = ({ onLogout, onSearch }: HeaderProps) => {
    ...
    return (
        <div className="flex items-center justify-between px-3 py-3.5  bg-gray-100 font-sans">
            {/*<div id="logoHome">*/}
            ...
            <nav className="hidden md:flex">
                ...
                <div className="flex items-center gap-12">
                    <div className="flex items-center gap-4 text-gray-800 font-semibold">
                        ...
                        <Link to="/topic" className="cursor-pointer hover:!text-gray-600" id="topicPage">
                            Chủ đề
                        </Link>
