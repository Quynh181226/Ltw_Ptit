...
const Header = ({ onLogout }: HeaderProps) => {
    ...
    return (
        <div className="flex items-center justify-between px-3 py-2  bg-gray-200 font-sans">
            {/*<div id="logoHome">*/}
            {/*    <img src="/assets/Group 1.svg" alt="Logo" className="h-10" />*/}
            {/*</div>*/}
            <Link to="/homePage" className="text-xl md:text-2xl font-bold text-gray-700">UniLife Hub</Link>
            ...
            <nav className="hidden md:flex">
                ...
                <div className="flex items-center gap-12">
                    <div className="flex items-center gap-4 text-gray-800 font-semibold">
                        <span className="cursor-pointer hover:text-gray-600" id="testPage">
                            Thi thử mỗi ngày
                        </span>
                        <span className="cursor-pointer hover:!text-gray-600" id="topicPage">
                            Chủ đề
                        </span>
            ...
            <button onClick={() => setOpen(!open)} className="md:hidden flex w-[44px] h-[36px] justify-center items-center rounded border !border-gray-400 bg-gray-200  hover:!bg-gray-100 active:!bg-gray-300 transition">
