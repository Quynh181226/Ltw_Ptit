                ...
                <div className="menu top">
                    ...
                    <div className="menu-item active">
                        <Link to="/categoryManagement"
                            className={`menu-link group ${sidebarOpen ? "" : "hide"} text-[#6B7597] ${
                                darkMode ? "dark" : ""
                            }`}
                        >
                            <svg className="min-w-[40px] flex justify-center fill-[#6B7597]" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path d="M7 3a4 4 0 1 0 0 8 4 4 0 1 0 0-8M17 3a4 4 0 1 0 0 8 4 4 0 1 0 0-8M7 13a4 4 0 1 0 0 8 4 4 0 1 0 0-8M18 13h-2v3h-3v2h3v3h2v-3h3v-2h-3z"></path></svg>
                            {sidebarOpen && (
                                <span>
                                Category
                              </span>
                    ...
                    <div className="menu-item">
                        ...
                        <Link to="/testManagement" className={`menu-link group ${sidebarOpen ? "" : "hide"} ${darkMode ? "dark" : ""}`}>
                            <svg className="min-w-[40px] flex justify-center fill-current group-hover:text-[#6B7597] transition-colors duration-200" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill={darkMode ? "#F9F9F9" : "#302E36"} viewBox="0 0 24 24"><path d="M4 2H2v19c0 .55.45 1 1 1h19v-2H4z"></path><path d="M7 10h11c.55 0 1-.45 1-1V5c0-.55-.45-1-1-1H7c-.55 0-1 .45-1 1v4c0 .55.45 1 1 1m10-2h-5V6h5zM8 6h2v2H8zM21 12H7c-.55 0-1 .45-1 1v4c0 .55.45 1 1 1h14c.55 0 1-.45 1-1v-4c0-.55-.45-1-1-1M8 14h6v2H8zm12 2h-4v-2h4z"></path></svg>
                            {sidebarOpen && (
                    ...
                    <form className="w-full mr-auto mt-5">
                        <div className="flex items-center h-9">
                            <input
                                type="search"
                                placeholder="Search..."
                                className={`max-[576px]:hidden flex-grow px-4 h-full border-2 rounded-[36px_0_0_36px] outline-none w-full transition-colors duration-300
                                   ${darkMode
